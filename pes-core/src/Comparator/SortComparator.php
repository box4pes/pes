...
class SortComparator implements ComparatorInterface {
     ...
     *
     * @param iterable<int, array{attribute: string, type: string}> $order Pole ve formátu array('nazev1'=>'ASC', 'nazev2=>'DESC'). nazev1, nazev 2 jsou názvy vlastností objektů - členů kolekce
