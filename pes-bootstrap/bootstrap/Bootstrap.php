...
include __DIR__ . "/SetBootstrapSettingsPath.php";
...
include __DIR__ . "/SetBootstrapDefaults.php";   // definuje nedefinované konstanty
...
include __DIR__ . "/SetGlobals.php";
...
include __DIR__ . "/CheckPhpIni.php";
// časké timezone a locale
include __DIR__ . "/SetCzechZone.php";
// error reporting, error handlery, exception handlery
include __DIR__ . "/SetErrorHandling.php";
...
// include __DIR__ . "/SetAssertionsExpectations.php";
